...
<template>
  <el-card shadow="never">
    <template #header>
      <strong>확인 메시지와 진행률</strong>
    </template>

    <el-button type="danger" @click="confirmDelete">삭제 테스트</el-button>
    <el-button type="primary" :loading="isDownloading" @click="startDownload"> 동기화 시작 </el-button>
    <el-progress class="progress" :percentage="downloadProgress" />
  </el-card>
</template>
